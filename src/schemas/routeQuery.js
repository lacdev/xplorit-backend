const routeQuerySchema = {
  ...
  properties: {
    ...
    limit: { type: 'string' }, //limit of routes per page, Default can be 5 or 9 if routes or reviews.
    sort: { type: 'string' }, //sort by likes or average always ascendent.
    latest: { type: 'boolean' }, //latest routes created, sorted by date of creation, false by default.
